...
│   └── exports/              # exported models (e.g., ONNX)
├── assets/
...
- Keep large generated files in `artifacts/` rather than repo root.
- If you publish results, document exact dataset splits and seeds.
